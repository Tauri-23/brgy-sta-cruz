    ...
    <body>
        ...
        <div class="content1 d-flex flex-direction-y gap1">
            ...
            <div class="w-100 mar-top-1">
                <input class="edit-text-1 w-50" type="text" id="announcement-title-in" placeholder="Announcement Title"/>
            </div>
            ...
            <div class="w-100 mar-top-1 d-flex flex-direction-y gap3">
                ...
                <div class="text-editor-content" id="text-editor-content" contenteditable="true"></div>
            </div>

            <div class="d-flex justify-content-end">
                <div>
                    <div class="primary-btn-blue1" id="post-announcement">Post Announcement</div>
                </div>
            </div>
