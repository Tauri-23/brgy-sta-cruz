...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        {{-- Navs --}}
        <x-navbar navType="landing-page" activeLink="2" pfp="null"/>
        ...
        <div class="content1 d-flex flex-direction-y gap1">
            ...
            <div class="d-flex flex-direction-y gap2">
                @foreach ($announcementsFt as $ann)
                    <a href="/publicViewAnnouncement/{{$ann->id}}" class="featured announcement-cont d-flex gap1 announcement-column text-decoration-none color-black">
            ...
            <div class="d-flex gap1">
                <div class="d-flex flex-direction-y w-75 gap2" id="announcement-cont">
                    <x-public_render_announcements :announcements="$announcements"/>
                </div>
